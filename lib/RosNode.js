...
let logging = require('../utils/log/logging.js');
let tcprosStringUtil = require('../utils/std_msgs/String.js');
        ...
        let server = net.createServer((connection) => {
          ...
          const checkConnectionHeader = (headerData) => {
            ...
            if (!header) {
              ...
              connection.end(tcprosStringUtil('Unable to validate connection header').serialize());
              return;
            }
